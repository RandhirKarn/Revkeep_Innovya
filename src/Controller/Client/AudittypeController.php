...
use App\Model\Table\InsuranceProviderInsuranceTypesTable; // Make sure to adjust the namespace

class AudittypeController extends AppController
{
    ...
    {
        parent::initialize();
        $this->Agency = new InsuranceProviderInsuranceTypesTable();
    }
